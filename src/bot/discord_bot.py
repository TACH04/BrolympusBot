    ...
    async with lock:
        ...
        try:
            ...
            if full_text:
                ...
                # Trigger background reaction image generation
                from bot.personality_reactions import generate_and_send_reaction_image
                asyncio.create_task(generate_and_send_reaction_image(active_msg, content, full_text))
            elif not full_text:
